config = {}
config['data_path'] = '../junnan-scratchpad/Noisy'
config['dataset'] = 'cifar10'
config['openset'] = 'cifar100'
#config['openset'] = 'svhn'
config['noise_ratio'] = 0.5 #symmetric noise ratio for cifar-10
config['noise_file'] = 'noise_file/%s/openset_%s.json'%(config['dataset'],config['openset'])
...
config['exp_directory'] = 'experiment/openset_%s'%config['openset']
